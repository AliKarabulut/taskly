  ...
  return (
    <thead>
      <tr className="grid grid-cols-12">
        ...
        <th scope="col" className="col-span-3 py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">
          Title
        </th>
        <th scope="col" className="col-span-5 px-3 py-3.5 text-left text-sm font-semibold text-gray-900">
          Description
        </th>
