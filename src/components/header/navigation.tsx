      ...
      {navigation.map(item => (
        <Link
          ...
          className={cn('inline-flex items-center border-b-2 px-1 pt-1 text-sm font-medium', {
            ...
            'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 dark:text-darkModeNeutral-200 dark:hover:border-darkModeNeutral-100 dark:hover:text-darkModeNeutral-100':
              pathname !== item.path,
          })}>
          {item.name}
        </Link>
